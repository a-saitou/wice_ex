...
describe CalendarsController do
  ...
  let(:valid_attributes) { { "hiduke" => "2016-08-18" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved calendar as @calendar" do
        ...
        post :create, {:calendar => { "hiduke" => "invalid value" }}, valid_session
        assigns(:calendar).should be_a_new(Calendar)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested calendar" do
        ...
        Calendar.any_instance.should_receive(:update).with({ "hiduke" => "2016-08-18" })
        put :update, {:id => calendar.to_param, :calendar => { "hiduke" => "2016-08-18" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the calendar as @calendar" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Calendar.any_instance.stub(:save).and_return(false)
        put :update, {:id => calendar.to_param, :calendar => { "hiduke" => "invalid value" }}, valid_session
        assigns(:calendar).should eq(calendar)
      end
