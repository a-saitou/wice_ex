...
describe WorksController do
  ...
  let(:valid_attributes) { { "calendar_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved work as @work" do
        ...
        post :create, {:work => { "calendar_id" => "invalid value" }}, valid_session
        assigns(:work).should be_a_new(Work)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested work" do
        ...
        Work.any_instance.should_receive(:update).with({ "calendar_id" => "1" })
        put :update, {:id => work.to_param, :work => { "calendar_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the work as @work" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Work.any_instance.stub(:save).and_return(false)
        put :update, {:id => work.to_param, :work => { "calendar_id" => "invalid value" }}, valid_session
        assigns(:work).should eq(work)
      end
