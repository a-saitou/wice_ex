class WorksController < ApplicationController
  ...
  private
    ...
    def work_params
      params.require(:work).permit(:calendar_id, :staff_id, :, :agreement_id, :start_time, :end_time, :work_time, :over_work_time, :late_night_over_time, :paid_holiday, :agency_holiday)
    end
end
